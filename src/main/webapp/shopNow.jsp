...
<jsp:include page="/GetCartCountServlet" />
<jsp:include page="/GetWishlistCountServlet" />
	...
	<div class="container-fluid">
		...
		int maxPaginationButtons = 5; // Maximum number of pagination buttons to display

		// Retrieve current page number from request parameter, default to 1 if not provided
		...
		try {
			...
			totalProducts = productDAO.getTotalProducts(); // Get total number of products
			...
			productList = productDAO.getProductsPerPage((currentPage - 1) * productsPerPage, productsPerPage);
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="page-btn">
					...
					%>
					<a href="shopNow.jsp?page=<%=i%>" class="pagination-style"><%=i%></a>
					<%
					}
					%>
					<%
